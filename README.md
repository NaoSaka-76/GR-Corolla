...
- **レース日程はTC America・スーパー耐久・ARAとも公式サイトから一覧表示**: ARAの公式
  ...
  対応した(1件のみ元HTMLが破損しており抽出不可)。一方、ARAの**シリーズランキング**は
  公式サイト自体に順位・ポイントの数値データが一切埋め込まれておらず、非公式の
  第三者サイトが提供する非公開フォーマットに依存しているため、引き続きグラフ化せず
  検索リンクのみとしている(日程とランキングで対応状況が異なる点に注意)。
