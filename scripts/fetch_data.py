    ...
    return {
        ...
        "sections": {
            ...
            "events": {
                ...
                "note": (
                    "発売告知やスペック発表などのプレスリリース記事は除外し、オーナーズ"
                    "ミーティング/ミートアップ、GR Corolla自体の試乗会・体験会、著名モーター"
                    "ショーへの展示・出展など「人が集まる」イベントに絞ってニュース記事から"
                    "集約した簡易カレンダーです。見出しに日付表記がある記事を上位に表示して"
                    "いますが、正確な日程・開催地は記事本文でしか分からないため("
                    "Google Newsのリンクは本文取得ができない仕組み)、参加を検討する際は"
                    "必ず元記事を開いて日程・場所をご確認ください。公式のイベント日程"
                    "一覧ではありません。"
                ),
            },
        },
